...
class AddNewStatusView extends StatefulWidget {
  const AddNewStatusView({super.key});

  @override
  State<AddNewStatusView> createState() => _AddNewStatusViewState();
}

class _AddNewStatusViewState extends State<AddNewStatusView> {
  File? selectedImage;
  File? selectedVideo;
